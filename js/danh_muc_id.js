window.QuyUocID = {
    // =========================================================================
    // TOÀN BỘ DANH MỤC ID TOÁN LỚP 12
    // =========================================================================
    lop12: {
        "2D1": {
            tenChuong: "Chương 1. Ứng dụng đạo hàm để khảo sát hàm số",
            baiHoc: {
                "1": {
                    tenBai: "§1. Sự đồng biến và nghịch biến của hàm số",
                    dangBai: {
                ...
                "2": {
                    ...
                    dangBai: {
                        ...
                        "6": "Tìm m để hàm số, đồ thị các hàm số khác có cực trị thỏa mãn điều kiện",
                        "7": "Toán thực tế ứng dụng cực trị của hàm số"
                    }
                },
                "3": {
                    tenBai: "§3. Giá trị lớn nhất và giá trị nhỏ nhất của hàm số",
                    dangBai: {
                ...
                "5": {
                    tenBai: "§5. Khảo sát sự biến thiên và vẽ đồ thị hàm số",
                    dangBai: {
                        "1": "Nhận dạng đồ thị",
        ...
        "2D3": {
            tenChuong: "Chương 3. Các số đặc trưng đo mức độ phân tán cho mẫu số liệu ghép nhóm",
            baiHoc: {
                "1": {
                    tenBai: "§1. Khoảng biến thiên, khoảng tứ phân vị của mẫu số liệu ghép nhóm",
                    dangBai: {
                ...
                "2": {
                    tenBai: "§2. Phương sai, độ lệch chuẩn của mẫu số liệu ghép nhóm",
                    dangBai: {
                        "1": "Công thức lý thuyết",
        ...
        "2D4": {
            tenChuong: "Chương 4. Nguyên hàm, tích phân và ứng dụng",
            baiHoc: {
                "1": {
                    tenBai: "§1. Nguyên hàm",
                    dangBai: {
                ...
                "3": {
                    tenBai: "§3. Ứng dụng thực tế và hình học của tích phân",
                    dangBai: {
                        ...
                        "5": "Bài toán thực tế và ứng dụng thể tích tròn xoay, S( )"
                    }
                }
            }
        },
        "2D6": {
            tenChuong: "Chương 6. Một số yếu tố xác suất",
            baiHoc: {
                "1": {
                    tenBai: "§1. Xác suất có điều kiện",
                    dangBai: {
                        "1": "Công thức lý thuyết",
                ...
                "2": {
                    tenBai: "§2. Công thức xác suất toàn phần. Công thức Bayes",
                    dangBai: {
                        "1": "Công thức lý thuyết",
        ...
        "2H2": {
            tenChuong: "Chương 2. Tọa độ của véc-tơ trong không gian",
            baiHoc: {
                "1": {
                    tenBai: "§1. Véc-tơ và các phép toán véc-tơ trong không gian (chưa toạ độ hoá)",
                    dangBai: {
                        "1": "Công thức lý thuyết",
                ...
                "2": {
                    tenBai: "§2. Toạ độ của véc-tơ và các công thức",
                    dangBai: {
                        "1": "Công thức lý thuyết",
                        "2": "Tìm tọa độ điểm",
                        "3": "Tìm tọa độ véc-tơ",
        ...
        "2H5": {
            tenChuong: "Chương 5. Phương trình mặt phẳng, đường thẳng, mặt cầu trong không gian Oxyz",
            baiHoc: {
                "1": {
                    tenBai: "§1. Phương trình mặt phẳng",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
                ...
                "2": {
                    tenBai: "§2. Phương trình đường thẳng trong không gian",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
                ...
                "3": {
                    tenBai: "§3. Phương trình mặt cầu trong không gian",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
    ...
    lop11: {"1D1": {
            ...
            baiHoc: {
                ...
                "2": {
                    tenBai: "§2. Giá trị lượng giác của một góc lượng giác",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
                        ...
                        "4": "Các góc lượng giác có liên quan đặc biệt: bù nhau, phụ nhau, đối nhau, hơn kém nhau",
                        "5": "Toán thực tế áp dụng giá trị của một góc lượng giác"
                    }
                },
                "3": {
                    tenBai: "§3. Các công thức lượng giác",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
                ...
                "4": {
                    tenBai: "§4. Hàm số lượng giác và đồ thị",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
                        "2": "Tìm tập xác định",
                        "3": "Xét tính đơn điệu",
                ...
                "5": {
                    tenBai: "§5. Phương trình lượng giác cơ bản",
                    dangBai: {
                ...
                "6": {
                    tenBai: "§6. [Giảm] Phương trình lượng giác thường gặp",
                    dangBai: {
        ...
        "1D2": {
            tenChuong: "Chương 2. Dãy số. Cấp số cộng. Cấp số nhân",
            baiHoc: {
                "1": {
                    tenBai: "§1. Dãy số",
                    dangBai: {
        ...
        "1D5": {
            ...
            baiHoc: {
                ...
                "2": {
                    tenBai: "§2. Trung vị và tứ phân vị của mẫu số liệu ghép nhóm",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
                        "2": "Trung vị",
                        "3": "Tứ phân vị"
        ...
        "1H4": {
            tenChuong: "Chương 4. Đường thẳng, mặt phẳng. Quan hệ song song trong không gian",
            baiHoc: {
                "1": {
                    tenBai: "§1. Điểm, đường thẳng và mặt phẳng",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
                ...
                "2": {
                    tenBai: "§2. Hai đường thẳng song song",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
                ...
                "3": {
                    tenBai: "§3. Đường thẳng và mặt phẳng song song",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
                ...
                "4": {
                    tenBai: "§4. Hai mặt phẳng song song",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
                ...
                "5": {
                    tenBai: "§5. Hình lăng trụ và hình hộp (xiên)",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
        ...
        "1H8": {
            ...
            baiHoc: {
                ...
                "2": {
                    tenBai: "§2. Đường thẳng vuông góc với mặt phẳng",
                    dangBai: {
                        "1": "Câu hỏi lí thuyết",
                ...
                "4": {
                    tenBai: "§4. Hai mặt phẳng vuông góc",
                    dangBai: {
                        "1": "Câu hỏi lí thuyết",
                ...
                "6": {
                    tenBai: "§6. Góc giữa đường thẳng và mặt phẳng. Góc nhị diện",
                    dangBai: {
                ...
                "7": {
                    tenBai: "§7. Hình lăng trụ đứng. Hình chóp đều. Thể tích",
                    dangBai: {
        ...
        "1C1": {
            tenChuong: "Chuyên đề 1. Phép biến hình phẳng",
            baiHoc: {
                "1": {
                    tenBai: "§1. Phép biến hình, phép dời hình và hai hình bằng nhau",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
        ...
        "1C2": {
            tenChuong: "Chuyên đề 2. Lý thuyết đồ thị",
            baiHoc: {
                "1": {
                    tenBai: "§1. Đồ thị",
                    dangBai: {
                ...
                "2": {
                    tenBai: "§2. Đường đi Euler và Hamilton",
                    dangBai: {
                        "1": "Đường đi Euler",
                        "2": "Đường đi Hamilton",
                        "3": "Câu hỏi tổng hợp"
                ...
                "3": {
                    tenBai: "§3. Bài toán tìm đường đi ngắn nhất",
                    dangBai: {
        ...
        "1C3": {
            tenChuong: "Chuyên đề 3. Một số yếu tố vẽ kỹ thuật",
            baiHoc: {
                "1": {
                    tenBai: "§1. Hình biểu diễn của một hình, khối",
                    dangBai: {
    ...
    // =========================================================================
    // TOÀN BỘ DANH MỤC ID TOÁN LỚP 10
    // =========================================================================
    lop10: {
        "0D1": {
            tenChuong: "Chương 1. Mệnh đề. Tập hợp",
            baiHoc: {
                "1": {
                    tenBai: "§1. Mệnh đề",
                    dangBai: {
                ...
                "3": {
                    tenBai: "§3. Các phép toán tập hợp",
                    dangBai: {
        ...
        "0D2": {
            tenChuong: "Chương 2. BPT và hệ BPT bậc nhất hai ẩn",
            baiHoc: {
                "1": {
                    tenBai: "§1. Bất phương trình bậc nhất hai ẩn",
                    dangBai: {
                ...
                "2": {
                    tenBai: "§2. Hệ bất phương trình bậc nhất hai ẩn",
                    dangBai: {
        ...
        "0D3": {
            tenChuong: "Chương 3. Hàm số bậc hai và đồ thị",
            baiHoc: {
                "1": {
                    tenBai: "§1. Hàm số và đồ thị",
                    dangBai: {
        ...
        "0D6": {
            tenChuong: "Chương 6. Thống kê",
            baiHoc: {
                "1": {
                    tenBai: "§1. Số gần đúng. Sai số",
                    dangBai: {
                ...
                "2": {
                    tenBai: "§2. Mô tả và biểu diễn dữ liệu trên các bảng và biểu đồ",
                    dangBai: {
                ...
                "3": {
                    tenBai: "§3. Các số đặc trưng đo xu thế trung tâm của mẫu số liệu",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
                ...
                "4": {
                    tenBai: "§4. Các số đặc trưng đo mức độ phân tán của mẫu số liệu",
                    dangBai: {
                        "1": "Câu hỏi lý thuyết",
        ...
        "0D7": {
            tenChuong: "Chương 7. Bất phương trình bậc 2 một ẩn",
            baiHoc: {
                "1": {
                    tenBai: "§1. Dấu của tam thức bậc 2",
                    dangBai: {
                ...
                "2": {
                    tenBai: "§2. Giải bất phương trình bậc 2 một ẩn",
                    dangBai: {
                        ...
                        "5": "Bất phương trình chứa căn, dấu giá trị tuyệt đối",
                        "6": "Bài toán có tham số m",
                        "7": "Toán thực tế ứng dụng bất phương trình bậc 2 một ẩn"
                    }
                },
                "3": {
                    tenBai: "§3. Phương trình quy về phương trình bậc hai",
                    dangBai: {
                        "1": "Phương trình căn thức dạng cơ bản vế bằng căn vế",
                        "2": "Phương trình căn thức dạng cơ bản vế bằng đa thức vế",
        ...
        "0D8": {
            tenChuong: "Chương 8. Đại số tổ hợp",
            baiHoc: {
                "1": {
                    tenBai: "§1. Quy tắc cộng-quy tắc nhân",
                    dangBai: {
                ...
                "2": {
                    tenBai: "§2. Hoán vị. Chỉnh hợp. Tổ hợp",
                    dangBai: {
        ...
        "0D0": {
            tenChuong: "Chương 10. Xác suất",
            baiHoc: {
                "1": {
                    tenBai: "§1. Không gian mẫu và biến cố",
                    dangBai: {
                        "1": "Các câu hỏi lý thuyết tổng hợp",
        ...
        "0H4": {
            tenChuong: "Chương 4. Hệ thức lượng trong tam giác",
            baiHoc: {
                "1": {
                    tenBai: "§1. Giá trị lượng giác của góc (0-180 độ)",
                    dangBai: {
                ...
                "2": {
                    tenBai: "§2. Định lý sin và định lý côsin",
                    dangBai: {
                ...
                "3": {
                    tenBai: "§3. Giải tam giác và ứng dụng thực tế",
                    dangBai: {
                        "1": "Giải tam giác",
        ...
        "0H5": {
            tenChuong: "Chương 5. Véctơ (chưa xét tọa độ)",
            baiHoc: {
                "1": {
                    tenBai: "§1. Khái niệm véctơ",
                    dangBai: {
                ...
                "2": {
                    tenBai: "§2. Tổng và hiệu của hai véctơ",
                    dangBai: {
                ...
                "3": {
                    tenBai: "§3. Tích của một số với véctơ",
                    dangBai: {
                ...
                "4": {
                    tenBai: "§4. Tích vô hướng (chưa xét tọa độ)",
                    dangBai: {
        ...
        "0H9": {
            tenChuong: "Chương 9. Phương pháp toạ độ trong mặt phẳng (Oxy)",
            baiHoc: {
                "1": {
                    tenBai: "§1. Toạ độ của véctơ",
                    dangBai: {
                ...
                "2": {
                    tenBai: "§2. Tích vô hướng (theo tọa độ)",
                    dangBai: {
                        "1": "Tích vô hướng, góc giữa 2 véctơ",
                        "2": "Tìm góc nhờ tích vô hướng",
                        "3": "Đẳng thức về tích vô hướng hoặc độ dài",
                ...
                "3": {
                    tenBai: "§3. Đường thẳng trong mặt phẳng toạ độ",
                    dangBai: {
                ...
                "4": {
                    tenBai: "§4. Đường tròn trong mặt phẳng toạ độ",
                    dangBai: {
                ...
                "5": {
                    tenBai: "§5. Ba đường conic trong mặt phẳng toạ độ",
                    dangBai: {
        ...
        "0C1": {
            tenChuong: "Chuyên đề 1. Hệ phương trình bậc nhất 3 ẩn và ứng dụng",
            baiHoc: {
                "1": {
                    tenBai: "§1. Hệ phương trình bậc nhất 3 ẩn và ứng dụng",
                    dangBai: {
        ...
        "0C2": {
            tenChuong: "Chuyên đề 2. Phương pháp quy nạp toán học",
            baiHoc: {
                "1": {
                    tenBai: "§1. Phương pháp quy nạp toán học",
                    dangBai: {
