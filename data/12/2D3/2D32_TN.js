...
window.tracNghiem2D32 = [
  {
    "id": "2D322TN1",
    "question": "Cho mẫu số liệu với cỡ mẫu $n$ được cho dưới bảng tần số ghép nhóm  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_000.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Số trung bình $\\overline x $ của mẫu số liệu trên được tính bằng công thức nào sau đây",
    "options": [
  ...
  {
    "id": "2D322TN2",
    "question": "Khảo sát về cân nặng của các học sinh lớp $11D3$ người ta được một mẫu dữ liệu ghép nhóm như sau:  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_001.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Số trung bình của mẫu số liệu trên là",
    "options": [
      "$56$",
      "$50$",
      "$60$",
    ...
    "answer": 0,
    "explain": "Ta có: Số phần tử của mẫu là $n=40$ và  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_002.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Do đó giá trị trung bình của mẫu số liệu trên là<br>  $\\overline x=\\dfrac{35\\cdot2+45\\cdot10+55\\cdot16+65\\cdot8+75\\cdot2+85\\cdot2}{40}=56$."
  },
  {
    "id": "2D322TN3",
    "question": "Thống kê về thời lượng mỗi trận đấu bi-a trong vòng tứ kết giải đấu European Open người ta được mẫu số liệu ghép nhóm như sau  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_003.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Số trung bình của mẫu số liệu trên gần nhất với giá trị nào sau đây",
    "options": [
      "$17$",
      "$17{,}5$",
      "$18$",
    ...
    "answer": 1,
    "explain": "Ta có số phần tử của mẫu là $n=56$ và  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_004.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Do đó giá trị trung bình của mẫu số liệu trên là  $  \\overline{x}=\\dfrac{11\\cdot3+14\\cdot12+17\\cdot15+20\\cdot24+23\\cdot2}{56}=\\dfrac{491}{28} \\approx 17{,}54.$"
  },
  {
    "id": "2D322TN4",
    "question": "Doanh thu bán hàng trong $20$ ngày được lựa chọn ngẫu nhiên của một của hàng được ghi lại ở bảng sau (đơn vị: triệu đồng)  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_005.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Số trung bình của mẫu số liệu trên thuộc khoảng nào trong các khoảng dưới đây?",
    "options": [
      "$[7 ; 9)$",
      "$[9 ; 11)$",
      "$[11 ; 13)$",
    ...
    "answer": 1,
    "explain": "Bảng tần số ghép nhóm theo giá trị đại diện là  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_006.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Số trung bình $\\overline{x}=\\dfrac{2\\cdot 6+7\\cdot8+7\\cdot10+3\\cdot12+1\\cdot 14}{20}=9{,}4$."
  },
  {
    "id": "2D322TN5",
    "question": "Trung tâm ngoại ngữ thống kê bảng điểm môn Tiếng Anh của một khóa học trong bảng bên dưới  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_007.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Số trung bình của mẫu số liệu thuộc khoảng nào trong các khoảng dưới đây?",
    "options": [
      "$[8;10)$",
      "$[4;6)$",
      "$[2;4)$",
    ...
    "answer": 1,
    "explain": "Ta có bảng thống kê theo giá trị đại diện như sau:  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_008.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Khi đó ta có số trung bình của mẫu số liệu trên được tính như sau: <br>  $\\overline{x}=\\dfrac{1.10+3.30+5.55+7.42+9.9}{10+30+55+42+9}\\approx 5,14.$"
  },
  {
    "id": "2D321TN6",
  ...
  {
    "id": "2D322TN8",
    "question": "Mỗi ngày bác Hương đều đi bộ để rèn luyện sức khỏe. Quãng đường đi bộ mỗi ngày (đơn vị km) của bác Hương trong $20$ ngày được thống kê lại ở bảng sau  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_009.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Phương sai của mẫu số liệu ghép nhóm là",
    "options": [
      "$3{,}39$",
      "$11{,}62$",
      "$0{,}1314$",
    ...
    "answer": 2,
    "explain": "Xét mẫu số liệu ghép nhóm cho bởi bảng sau  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_010.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Số trung bình của mẫu số liệu là   $\\overline{x}=\\dfrac{1}{20}\\cdot (2{,}85\\cdot 3+3{,}15\\cdot 6+3{,}45\\cdot 5+3{,}75\\cdot 4+4{,}05\\cdot 2)=3{,}39.$  Phương sai của mẫu số liệu ghép nhóm là   $S^2=\\dfrac{1}{20}\\left(3\\cdot 2{,}85^2+6\\cdot 3{,}15^2+5\\cdot 3{,}45^2+4\\cdot 3{,}45^2+2\\cdot 4{,}05^2\\right)-3{,}39^2=0{,}1314.$"
  },
  {
    "id": "2D322TN9",
    "question": "Bạn Chi rất thích nhảy hiện đại. Thời gian tập nhảy mỗi ngày trong thời gian gần đây của bạn Chi được thống kê lại ở bảng sau  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_011.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Phương sai của mẫu số liệu ghép nhóm có giá trị gần nhất với giá trị nào dưới đây?",
    "options": [
      "$31{,}77$",
      "$32$",
      "$31$",
    ...
    "answer": 3,
    "explain": "Xét mẫu số liệu ghép nhóm cho bởi bảng sau  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_012.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Số trung bình của mẫu số liệu là   $\\overline{x}=\\dfrac{1}{18}\\cdot (22{,}5\\cdot 6+27{,}5\\cdot 6+32{,}5\\cdot 4+37{,}5\\cdot 1+42{,}5\\cdot 1)=\\dfrac{85}{3}.$  Phương sai của mẫu số liệu ghép nhóm là   $S^2=\\dfrac{1}{18}\\left(6\\cdot 22{,}5^2+6\\cdot 27{,}5^2+4\\cdot 32{,}5^2+1\\cdot 37{,}5^2+1\\cdot 42{,}5^2\\right)-\\left(\\dfrac{85}{3}\\right)^2=31{,}25.$  Vậy phương sai của mẫu số liệu ghép nhóm gần nhất với $31{,}44$."
  },
  {
    "id": "2D322TN10",
    "question": "Mỗi ngày bác Hương đều đi bộ để rèn luyện sức khỏe. Quãng đường đi bộ mỗi ngày (đơn vị km) của bác Hương trong $20$ ngày được thống kê lại ở bảng sau  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_013.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Độ lệch chuẩn của mẫu số liệu ghép nhóm có giá trị gần nhất với giá trị nào dưới đây?",
    "options": [
      "$3{,}41$",
      "$11{,}62$",
      "$0{,}017$",
  ...
  },
  {
    ...
    "answer": 2,
    "explain": "Xét mẫu số liệu ghép nhóm cho bởi bảng sau  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_016.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Số trung bình của mẫu số liệu là   $\\overline{x}=\\dfrac{1}{25}\\cdot (9\\cdot 4+11\\cdot 6+13\\cdot 8+15\\cdot 4+17\\cdot 3)=12{,}68.$  Phương sai của mẫu số liệu ghép nhóm là   $S^2=\\dfrac{1}{25}\\left(4\\cdot 9^2+6\\cdot 11^2+8\\cdot 13^2+4\\cdot 15^2+3\\cdot 17^2\\right)-12{,}68^2=5{,}9776.$  Độ lệch chuẩn của mẫu số liệu là   $S=\\sqrt{5{,}9776}=\\approx 2{,}445.$  Vậy độ lệch chuẩn của mẫu số liệu ghép nhóm gần nhất với $2{,}44$."
  },
  {
    "id": "2D322TN12",
    "question": "Để đánh giá chất lượng một lọa pin điện thoại mới, người ta ghi lại thời gian nghe nhạc liên tục của điện thoại được sạc đầy pin cho đến khi hết pin cho kết quả sau  <br><img src=\"data/12/2D3/im2D3/2D32_tikz_017.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Tính độ lệch chuẩn của mẫu số liệu ghép nhóm trên (làm tròn đến 4 chữ số thập phân).",
    "options": [
      "$0{,}4252$",
      "$0{,}5314$",
      "$0{,}6214$",
    ...
    "answer": 3,
    "explain": "<br><img src=\"data/12/2D3/im2D3/2D32_tikz_018.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Số trung bình của mẫu số liệu<br>  $ \\overline{x}=\\dfrac{m_{1}\\cdot x_{1}+\\dots+m_{k}\\cdot x_{k}}{n}=\\dfrac{2\\cdot5{,}25+8\\cdot 5{,}75+15\\cdot 6{,}25+10\\cdot 6{,}75+5\\cdot7{,}25}{40}=6{,}35 $.<br>  Phương sai của mẫu số liệu ghép nhóm  $ s^{2}=\\dfrac{1}{40}\\cdot\\left(2\\cdot 5{,}25^{2}+8\\cdot 5{,}75^{2}+15\\cdot 6{,}25^{2}+10\\cdot 6{,}75^{2}+5\\cdot 7{,}25^{2}\\right)-6{,}35^{2}=0{,}2775 $.  Độ lệch chuẩn của mẫu số liệu ghép nhóm  $ s=\\sqrt{s^{2}}=\\sqrt{0{,}2775}\\approx 0{,}5268 $."
  },
  {
    "id": "2D322TN13",
    "question": "Một vườn thú ghi lại tuổi thọ (đơn vị: năm) của $30$ con hổ và thu được kết quả như sau  <br><img src=\"data/12/2D3/im2D32/dlts_12_DLTS11_004.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Độ lệch chuẩn của mẫu số liệu ghép nhóm trên là",
    "options": [
      "$1{,}38$",
      "$1{,}27$",
      "$2{,}3$",
  ...
  {
    "id": "2D322TN15",
    "question": "Khảo sát về độ ẩm không khí trung bình các tháng năm $2022$ tại Đà Nẵng (đơn vị: \\%), người ta được một mẫu dữ liệu ghép nhóm như sau:  <br><img src=\"data/12/2D3/im2D32/dlts_12_DLTS15_003.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Phương sai của mẫu số liệu ghép nhóm trên là",
    "options": [
      "$ 11{,}1875 $",
      "$ 3{,}34 $",
      "$ 80{,}25 $",
  ...
  },
  {
    ...
    "answer": 0,
    "explain": "Bảng giá trị đại diện  <br><img src=\"data/12/2D3/im2D32/dlts_12_DLTS19_006.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Cỡ mẫu là $n = 20$.<br>  Số trung bình là $\\overline{x} = \\dfrac{3\\cdot2{,}85 + 6\\cdot3{,}15 + 5\\cdot3{,}45 + 4\\cdot3{,}75 + 2\\cdot4{,}05}{20}=3{,}39$.<br>  Phương sai là $s^2= \\dfrac{3\\cdot\\left(2{,}85-3{,}39\\right)^2 + \\cdots + 2\\cdot\\left(4{,}05-3{,}39\\right)^2}{20}=0{,}1314$.<br>  Độ lệch chuẩn là $s = \\sqrt{s^2} = \\sqrt{0{,}1314} \\approx 0{,}36$."
  },
  {
    "id": "2D322TN18",
  ...
  {
    "id": "2D322TN21",
    "question": "Một mẫu số liệu có bảng tần số ghép nhóm như sau  <br><img src=\"data/12/2D3/im2D32/dlts_12_DLTS21_003.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Phương sai của mẫu số liệu là",
    "options": [
      "$21{,}01$",
      "$20{,}01$",
      "$22$",
  ...
  {
    "id": "2D322TN22",
    "question": "Một siêu thị thống kê số tiền (đơn vị: chục nghìn đồng) mà 44 khách hàng mua hàng ở siêu thị đó trong một ngày. Số liệu được ghi lại trong Bảng sau.  <br><img src=\"data/12/2D3/im2D32/dlts_12_DLTS25_002.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Phương sai của mẫu số liệu ghép nhóm trên là (kết quả làm tròn đến hàng phần mười)",
    "options": [
      "$53{,}2$",
      "$6{,}8$",
      "$47{,}2$",
  ...
  },
  {
    ...
    "answer": 0,
    "explain": "Xét mẫu số liệu $M_1$:  <br><img src=\"data/12/2D3/im2D32/dlts_12_DLTS36_007.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Ta có $n=25$. Khi đó $\\overline{x}=\\dfrac{3\\cdot 9+4\\cdot 11+8\\cdot 13+6\\cdot 15+4\\cdot 17}{25}=\\dfrac{333}{25}$.<br>   Độ lệch chuẩn của một mẫu số liệu $M_1$ là  $s=\\sqrt{\\dfrac{3(9-\\overline{x})^2+4(11-\\overline{x})^2+8(13-\\overline{x})^2+6(15-\\overline{x})^2+4(17-\\overline{x})^2}{25}}=2{,}445.$  Mẫu số liệu $M_2$:  <br><img src=\"data/12/2D3/im2D32/dlts_12_DLTS36_008.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Ta có $n=50$. Khi đó $\\overline{x}=\\dfrac{6\\cdot 9+8\\cdot 11+16\\cdot 13+12\\cdot 15+8\\cdot 17}{50}=\\dfrac{333}{25}$.<br>   Độ lệch chuẩn của một mẫu số liệu $M_2$ là  $s=\\sqrt{\\dfrac{6(9-\\overline{x})^2+8(11-\\overline{x})^2+16(13-\\overline{x})^2+12(15-\\overline{x})^2+8(17-\\overline{x})^2}{50}}=2{,}445.$"
  },
  {
    "id": "2D322TN24",
    "question": "Thống kê độ tuổi tập thể dục thể thao hàng ngày trong một cụm dân cư có bảng số liệu sau  <br><img src=\"data/12/2D3/im2D32/dlts_12_DLTS38_001.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Tính phương sai của mẫu số liệu trên (kết quả làm tròn đến hàng phần trăm).",
    "options": [
      "$189{,}66$",
      "$13{,}68$",
      "$187{,}13$",
