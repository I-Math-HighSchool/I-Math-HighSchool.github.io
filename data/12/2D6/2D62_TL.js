...
window.traLoiNgan2D62 = [
  ...
  },
  {
    ...
    "answer": "0,58",
    "explain": "Gọi $A$ là biến cố \\lq \\lq Học sinh đó lựa chọn tổ hợp D07 \\rq \\rq.<br>  Gọi $B$ là biến cố \\lq \\lq Học sinh đó đỗ đại học \\rq \\rq.<br>  Theo giả thiết, ta có $\\mathrm{P}(A)=60\\%$, $\\mathrm{P} \\left(B \\mid A\\right)=0{,}5$, $\\mathrm{P} \\left(B \\mid \\overline{A}\\right)=0{,}71$.<br>  Theo công thức xác suất toàn phần, ta có  $\\mathrm{P} (B) =\\mathrm{P} \\left(B \\mid A\\right) \\cdot \\mathrm{P} (A)+ \\mathrm{P} \\left(B \\mid \\overline{A}\\right) \\cdot \\mathrm{P} \\left(\\overline{A}\\right)$<br>$=0{,}5 \\cdot 60\\% + 0{,}71 \\cdot \\left(1-60\\%\\right)$<br>$\\approx 0{,}58.$  Vậy xác suất để học sinh được chọn đỗ đại học vào khoảng $0{,}58$."
  },
  {
    "id": "2D624TL8",
