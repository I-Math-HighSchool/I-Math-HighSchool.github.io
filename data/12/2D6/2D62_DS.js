...
window.dungSai2D62 = [
  {
    "id": "2D622DS1",
    "question": "Một lớp có $70\\%$ học sinh là nữ. Tỉ lệ học sinh nữ đạt danh hiệu học sinh giỏi là $35\\%$, tỉ lệ học sinh nam đạt danh hiệu học sinh giỏi là $60\\%$. Chọn ngẫu nhiên một học sinh của lớp đó. Gọi $A$ là biến cố \\lq \\lq Học sinh được chọn là nữ\\rq \\rq và $B$ là biến cố \\lq \\lq Học sinh được chọn đạt danh hiệu học sinh giỏi\\rq \\rq.",
    "subQuestions": [
      {
  ...
  {
    "id": "2D622DS2",
    "question": "Một hộp có $12$ quả bóng màu xanh, $7$ quả bóng màu đỏ; các quả bóng có kích thước và khối lượng như nhau. Lấy ngẫu nhiên lần lượt hai quả bóng trong hộp, lấy không hoàn lại. Xét các biến cố:  <br>- $A$: \\lq\\lq Lần thứ hai lấy được quả màu đỏ\\rq\\rq.<br>- $B$: \\lq\\lq Lần thứ nhất lấy được quả màu xanh\\rq\\rq.",
    "subQuestions": [
      {
        "text": "${P}(B)=\\dfrac{7}{9}$",
        "answer": false
  ...
  {
    "id": "2D624DS3",
    "question": "Trong một xưởng máy, số linh kiện do cơ sở I sản xuất chiếm $61 \\%$, số linh kiện do cơ sở II sản xuất chiếm $39 \\%$. Tỉ lệ linh kiện đạt tiêu chuẩn của cơ sở I, cơ sở II lần lượt là $93\\%$, $82\\%$. Kiểm tra ngẫu nhiên một linh kiện ở xưởng máy. Xét các biến cố<br>  $A_1 \\colon$ \\lq\\lq Linh kiện được kiểm tra do cơ sở I sản xuất\\rq\\rq;<br>  $A_2 \\colon$ \\lq\\lq Linh kiện được kiểm tra do cơ sở II sản xuất\\rq\\rq;<br>  $B \\colon$ \\lq\\lq Linh kiện được kiểm tra đạt tiêu chuẩn\\rq\\rq.",
    "subQuestions": [
      {
