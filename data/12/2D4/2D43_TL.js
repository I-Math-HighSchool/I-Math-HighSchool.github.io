...
window.traLoiNgan2D43 = [
  ...
  {
    "id": "2D431TL2",
    "question": "Cho hình phẳng (phần gạch chéo ở hình vẽ bên dưới) được giới hạn bởi parabol $(P)$ và đường thẳng $d$. Tính diện tích của hình phẳng đó.  <br><img src=\"data/12/2D4/im2D43/dlts_12_DLTS16_001.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">",
    "answer": "4,5",
