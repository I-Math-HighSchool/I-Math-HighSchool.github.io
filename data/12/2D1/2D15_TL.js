// =========================================================================
// KHỐI DỮ LIỆU: §5. Khảo sát và vẽ đồ thị hàm số - Trả lời ngắn
...
window.traLoiNgan2D15 = [
  ...
  },
  {
    ...
    "answer": "0",
    "explain": "Phương trình hoành độ giao điểm:<br>  ${\\dfrac{1-x^3}{x} = n}$.<br>  Xét hàm số $f(x)=\\dfrac{1-x^3}{x}$: Tập xác định $\\mathscr{D}=\\mathbb{R}\\backslash\\{0\\}$.<br>  Ta có ${f(x) = 0}$ khi $x=1$.<br>  $f'(x)=-\\dfrac{1}{x^2}-2x=0 \\Leftrightarrow x^3=-\\dfrac{1}{2} \\Rightarrow x=-\\dfrac{1}{\\sqrt[3]{2}}$.<br>  Ta có bảng biến thiên của hàm số $f(x)=\\dfrac{1-x^3}{x}$.  <br><img src=\"data/12/2D1/im2D1/2D15_tikz_031.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Theo đề bài ta có: Với mỗi số tự nhiên dương $n$, đồ thị hàm số $f(x) = \\dfrac{1 - x^3}{x}$ luôn cắt đường thẳng $y = n$ tại một điểm có hoành độ là $a_n$.<br>  Từ bảng biến thiên suy ra $0&lt;a_n\\le 1$ nên $\\lim \\limits_{x \\to {+\\infty}} {a_n}=0$."
  },
  {
    "id": "2D152TL8",
  ...
  {
    "id": "2D151TL9",
    "question": "Cho hàm số $y=\\dfrac{ax+b}{cx-1}$ có đồ thị như hình vẽ bên. Tính giá trị của biểu thức $S=a+b+c$.  <br><img src=\"data/12/2D1/im2D1/2D15_tikz_038.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">",
    "answer": "2",
  ...
  },
  {
    ...
    "answer": "9",
    "explain": "Ta có $v(t)=s'(t)=3at^2+2bt+c$.<br>  Dựa vào đồ thị, ta có hệ phương trình  $s(0)=0 \\text{ và } s(2)=12 \\text{ và } s(4)=24 \\text{ và } s'(4)=0 \\Leftrightarrow d=0 \\text{ và } 8a+4b+2c+d=12 \\text{ và } 64a+16b+4c+d=24 \\text{ và } 48a+8b+c=0 \\Leftrightarrow a=-\\dfrac{3}{4} \\text{ và } b=\\dfrac{9}{2} \\text{ và } c=0 \\text{ và } d=0.$  $ \\Rightarrow s(t)=-\\dfrac{3}{4}t^3+\\dfrac{9}{2}t^2$.<br>  Vậy $v(t)=-\\dfrac{9}{4}t^2+9t$. Ta có $v'(t)=-\\dfrac{9}{2}t+9$.<br>  Xét $v'(t)=0 \\Leftrightarrow t=2$.<br>  Ta có bảng biến thiên của $v(t)$  <br><img src=\"data/12/2D1/im2D15/dlts_12_DLTS12_016.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">  Vậy vận tốc tối đa của học sinh đó đạt được trong quá trình đi bộ là $9$ km/h."
  },
  {
    "id": "2D151TL21",
    "question": "Cho hàm số $y=ax+2+\\dfrac{b}{x+c}$ có đồ thị như hình vẽ ($a$, $b$, $c$ là các hằng số thực). Tính $P=a+b+c.$<br><img src=\"data/12/2D1/im2D15/dlts_12_DLTS2_013.png\" alt=\"hinh ve\" style=\"max-width:min(420px,85%);max-height:240px;width:auto;height:auto;display:block;margin:8px auto;\">",
    "answer": "-3",
