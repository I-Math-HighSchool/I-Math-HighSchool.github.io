...
window.traLoiNgan2D12 = [
  ...
  },
  {
    ...
    "answer": "0,75",
    "explain": "<br><img src=\"data/12/2D1/im2D1/2D12_tikz_067.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\"> Gọi $ BT=x $ (km) ($ 0&lt;x&lt;4 $).<br> Chi phí $C(x)=30\\cdot (4 - x) + 50\\sqrt{x^{2}+1}=120 - 30x + 50\\sqrt{x^{2}+1}$.<br> Khi đó, ta có $C'(x)= -30 + \\dfrac{50x}{\\sqrt{x^{2}+1}}$.<br> Cho $ C'(x)=0 \\Leftrightarrow \\dfrac{50x}{\\sqrt{x^{2}+1}} = 30 25x^{2} = 9(x^{2}+1) \\Leftrightarrow 16x^{2} = 9 \\Leftrightarrow x=-0{,}75 \\text{(nhận)} \\text{ hoặc } x=0{,}75 \\text{(nhận)}.$<br> Ta có bảng biến thiên như sau <br><img src=\"data/12/2D1/im2D1/2D12_tikz_068.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\"> Vậy khoảng cách từ điểm $ T $ đến nhà máy nước là $ 0{,}75 $ km để tổng chi phí là thấp nhất."
  },
  {
    "id": "2D121TL28",
