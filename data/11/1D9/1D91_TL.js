...
window.traLoiNgan1D91 = [
  {
    ...
    "answer": "0{,}35",
    "explain": "Tổng số quả cầu trong hộp là $5 + 6 = 11$ quả cầu.<br>  Số cách chọn ngẫu nhiên $4$ quả cầu từ $11$ quả cầu là tổ hợp chập $4$ của $11$.<br>  $n(\\Omega) = C_{11}^4 = 330$ cách.<br>  Gọi $A$ là biến cố \\lq\\lq trong $4$ quả cầu lấy ra có ít nhất $3$ quả cầu đen\\rq\\rq.<br>  Biến cố $A$ xảy ra khi có $3$ quả cầu đen và $1$ quả cầu trắng, hoặc có $4$ quả cầu đen và $0$ quả cầu trắng.<br>  Trường hợp 1: Chọn $3$ quả cầu đen và $1$ quả cầu trắng.<br>  Số cách chọn $3$ quả đen từ $6$ quả đen là $C_6^3 = 20$ cách.<br>  Số cách chọn $1$ quả trắng từ $5$ quả trắng là $C_5^1 = 5$ cách.<br>  Số cách chọn cho trường hợp 1 là $C_6^3 \\cdot C_5^1 = 20 \\cdot 5 = 100$ cách.<br>  Trường hợp 2: Chọn $4$ quả cầu đen và $0$ quả cầu trắng.<br>  Số cách chọn $4$ quả đen từ $6$ quả đen là $C_6^4 = 15$ cách.<br>  Số cách chọn $0$ quả trắng từ $5$ quả trắng là $C_5^0 = 1$ cách.<br>  Số cách chọn cho trường hợp 2 là $C_6^4 \\cdot C_5^0 = 15 \\cdot 1 = 15$ cách.<br>  Số kết quả thuận lợi cho biến cố A là $n(A) = 100 + 15 = 115$ cách.<br>  Xác suất của biến cố A là<br>  $\\mathrm{P}(A) = \\dfrac{n(A)}{n(\\Omega)} = \\dfrac{115}{330} = \\dfrac{23}{66}\\approx 0{,}35$.<br>  Vậy xác suất để có ít nhất $3$ quả cầu đen là khoảng $0{,}35$."
  },
  {
    "id": "1D913TL2",
  ...
  {
    "id": "1D913TL3",
    "question": "Hai bệnh nhân $X$ và $Y$ bị nhiễm một loại virút. Biết rằng xác suất bị biến chứng nặng của bệnh nhân $X$ là $0{,}73$ và của bệnh nhân $Y$ là $0{,}55$. Khả năng bị biến chứng nặng của hai bệnh nhân là độc lập. Tính xác suất của biến cố \\lq\\lq Có đúng một bệnh nhân không bị biến chứng nặng\\rq\\rq\\, (làm tròn kết quả đến hàng phần trăm).",
    "answer": "0{,}48",
    "explain": "Gọi $X$ là biến cố \\lq\\lq Bệnh nhân X bị biến chứng nặng\\rq\\rq\\;<br>  $Y$ là biến cố \\lq\\lq Bệnh nhân Y bị biến chứng nặng\\rq\\rq\\.<br>  Xác suất của biến cố \\lq\\lq Có đúng một bệnh nhân không bị biến chứng nặng\\rq\\rq\\, là  $\\mathrm{P}\\left(\\overline{X}Y\\right)+\\mathrm{P}\\left(X\\overline{Y}\\right)=(1-0{,}73)\\cdot 0{,}55+0{,}73\\cdot(1-0{,}55)=0{,}477.$"
  },
  {
    "id": "1D912TL4",
