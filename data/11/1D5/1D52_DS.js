...
window.dungSai1D52 = [
  {
    "id": "1D523DS1",
    "question": "Đo thời gian chạy cự li $1000$ m (đơn vị: giây) của các bạn học sinh trong lớp $11A$ thu được mẫu  số liệu ghép nhóm sau:  <br><img src=\"data/11/1D5/im1D52/dlts_11_DLTS19_004.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\">",
    "subQuestions": [
      {
    ...
    "explain": "<br>- $n=3+8+14+10+5=40$, $\\dfrac{n}{2}=\\dfrac{40}{2}=20\\Rightarrow Q_2$ thuộc $[129;131)$. <br>   $Q_2=129+\\dfrac{20-(3+8)}{14}\\cdot (131-129)=\\dfrac{912}{7}$.<br>   $\\dfrac{n}{4}=\\dfrac{40}{4}=10\\Rightarrow Q_1$ thuộc $[127;129)$.<br>   $Q_1=127+\\dfrac{10-3}{8}\\cdot (129-127)=\\dfrac{515}{4}$.<br>  $Q_2-Q_1=\\dfrac{912}{7}-\\dfrac{515}{4}=\\dfrac{43}{28}\\Rightarrow m=43$, $n=28$, $m+n=43+28=71$.<br>- $\\dfrac{n}{2}=\\dfrac{40}{2}=20\\Rightarrow Q_2$ thuộc $[129;131)$.<br>- Bảng giá trị đại diện  <br><img src=\"data/11/1D5/im1D52/dlts_11_DLTS19_005.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\">  $\\overline{x}=\\dfrac{3\\cdot 126+8\\cdot 128+14\\cdot 130+10\\cdot 132+5\\cdot 134}{3+8+14+10+5}=\\dfrac{1303}{10}$.<br>- $\\dfrac{n}{4}=\\dfrac{40}{4}=10\\Rightarrow Q_1$ thuộc $[127;129)$."
  },
  {
    "id": "1D523DS2",
    "question": "Số năm giảng dạy của một số giáo viên trường THPT A được ghi lại ở bảng sau  <br><img src=\"data/11/1D5/im1D52/dlts_11_DLTS35_002.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\">",
    "subQuestions": [
      {
