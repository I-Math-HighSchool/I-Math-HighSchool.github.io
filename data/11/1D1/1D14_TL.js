...
window.traLoiNgan1D14 = [
  ...
  },
  {
    ...
    "answer": "150",
    "explain": "Thành phố X có nhiều giờ có ánh sáng mặt trời nhất khi $d(t)$ đạt giá trị lớn nhất.  Ta có $\\sin\\left[\\dfrac{\\pi}{180}(t-60)\\right] \\le 1 \\Rightarrow d(t)=3\\sin\\left[\\dfrac{\\pi}{180}(t-60)\\right] + 8 \\le 3 \\cdot 1 + 8 = 11.$  Dấu \\lq\\lq$=$\\rq\\rq xảy ra khi   $\\sin\\left[\\dfrac{\\pi}{180}(t-60)\\right] = 1 \\Leftrightarrow \\dfrac{\\pi}{180}(t-60) = \\dfrac{\\pi}{2} + k2\\pi$<br>$\\Leftrightarrow \\dfrac{t-60}{180} = \\dfrac{1}{2} + 2k$<br>$\\Leftrightarrow t = 150 + 360k \\quad (k \\in \\mathbb{Z}).$  Vì $0 &lt; t \\le 365$ nên $0 &lt; 150 + 360k \\le 365 \\Rightarrow k = 0$. <br>  Vậy vào ngày thứ $150$ trong năm, thành phố X có nhiều giờ có ánh sáng mặt trời nhất."
  },
  {
    "id": "1D142TL15",
