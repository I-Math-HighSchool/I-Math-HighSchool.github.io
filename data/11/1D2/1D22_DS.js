...
window.dungSai1D22 = [
  ...
  {
    "id": "1D222DS4",
    "question": "Em P sau khi học bài “ Cấp số cộng” đã về nhà lấy đậu để chơi trò xếp hạt đậu thành các hàng sao cho số hạt đậu ở các hàng tạo thành dãy cấp số cộng $(u_n)$. Biết ở hàng đầu tiên P xếp $5$ hạt đậu, hàng thứ hai P xếp $9$ hạt đậu.",
    "subQuestions": [
      {
