...
window.dungSai1H44 = [
  {
    "id": "1H442DS1",
    "question": "Cho hình chóp $S. ABCD$ có đáy là hình bình hành tâm $O$. Gọi $M$, $N$ lần lượt là trung điểm của $SA$, $AD$, (hình vẽ).<br><img src=\"data/11/1D4/im1H44/dlts_11_DLTS12_002.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\">",
    "subQuestions": [
      {
