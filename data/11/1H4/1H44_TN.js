...
window.tracNghiem1H44 = [
  ...
  },
  {
    ...
    "answer": 3,
    "explain": "Ta có $CC'\\perp \\left(ABCD\\right)$ (vì $ABCD.A'BC'D'$ là hình lập phương).<br>  Lại có $CC'\\subset \\left(ACC'A'\\right)$.<br>  Từ đó suy ra hai mặt phẳng $\\left(ABCD\\right)$ và $\\left(ACC'A'\\right)$ vuông góc với nhau nên góc giữa chúng bằng $90^{\\circ}$."
  },
  {
    "id": "1H442TN5",
  ...
  {
    "id": "1H441TN4",
    "question": "Cho $(\\alpha) \\parallel(\\beta)$. Khẳng định nào sau đây là đúng?",
    "options": [
      "$(\\alpha)$ và $(\\beta)$ có duy nhất một điểm chung",
      "($\\alpha$) và ($\\beta$) có vô số điểm chung",
      "$(\\alpha)$ và $(\\beta)$ không có điểm chung",
      "($\\alpha$) và ($\\beta$) có $2$ điểm chung"
    ],
    "answer": 2,
    "explain": "Vì $(\\alpha) \\parallel(\\beta)$ nên $(\\alpha)$ và $(\\beta)$ không có điểm chung."
  },
  {
    "id": "1H441TN2",
  ...
  },
  {
    ...
    "answer": 1,
    "explain": "Khoảng cách giữa hai mặt đáy của lăng trụ là $AA'=2a$."
  },
  {
    "id": "1H442TN7",
