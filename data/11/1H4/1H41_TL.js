...
window.traLoiNgan1H41 = [
  {
    ...
    "answer": "3",
    "explain": "<br><img src=\"data/11/1D4/im1H41/dlts_11_DLTS4_003.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\">  Gọi $E$ là trọng tâm của tam giác $ACD$, $M$ là trung điểm của $CD$.<br>  Nối $BE$ cắt $AA'$ tại $G$ suy ra $G$ là trọng tâm tứ diện.<br>  Xét tam giác $MAB$, có $\\dfrac{ME}{MA} = \\dfrac{MA'}{MB}=\\dfrac{1}{3}$ suy ra $A'E \\parallel AB \\Rightarrow \\dfrac{A'E}{AB} = \\dfrac{1}{3}$.<br>  Khi đó, theo định lý Thales suy ra $\\dfrac{A'E}{AB}=\\dfrac{A'G}{AG}=\\dfrac{1}{3} \\Rightarrow \\dfrac{GA}{GA'}= 3$."
  },
  {
    "id": "1H414TL2",
