// =========================================================================
// KHỐI DỮ LIỆU: 1H45 - Trắc nghiệm
// Nguồn: Đề thi Giữa Kì/Cuối Kì thật từ các trường THPT (thư mục LocID/BANK-25-26,
// đợt 3), giữ nguyên nội dung gốc, chỉ định dạng lại cho khớp cấu trúc dữ liệu.
// =========================================================================
window.tracNghiem1H45 = [
  {
    "id": "1H451TN1",
    "question": "Trong một hình lăng trụ, khẳng định nào sau đây <strong>sai</strong>?",
    "options": [
  ...
  {
    "id": "1H451TN2",
    "question": "Cho hình hộp $ABCD.A'B'C'D'$. Khẳng định nào sau đây đúng?",
    "options": [
  ...
  },
  {
    ...
    "answer": 0,
    "explain": "Ta thấy hình lăng trụ tam giác $ABC.A'B'C'$ có 5 mặt."
  },
  {
    "id": "1H452TN4",
    "question": "Số cạnh của hình lăng trụ tam giác là",
    "options": [
      "$5$",
      "$12$",
      "$6$",
    ...
    "answer": 3,
    "explain": "Lăng trụ tam giác có $9$ cạnh."
  },
  {
    "id": "1H452TN1",
    ...
    "answer": 0,
    "explain": "Hình biểu diễn của một hình tứ diện là hình $(I)$, $(II)$, $(IV)$."
  }
];
