...
window.dungSai1H87 = [
  ...
  {
    "id": "1H872DS6",
    "question": "Cho hình chóp $S.ABCD$ có đáy $ABCD$ là hình vuông tâm $O$, cạnh bằng $a$, cạnh bên $SA$ vuông góc với mặt phẳng đáy và $SA=a$ (minh họa bằng hình vẽ).<br><img src=\"data/11/1D8/im1H87/dlts_11_DLTS35_004.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\">",
    "subQuestions": [
      {
