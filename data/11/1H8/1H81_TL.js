...
window.traLoiNgan1H81 = [
  {
    "id": "1H812TL1",
    "question": "Cho hình chóp $S.ABCD$ có đáy là hình vuông cạnh $a$, $SA \\perp (ABCD)$, $SA=a\\sqrt{2}$. Tính góc giữa $AD$ và $SC$ (theo đơn vị độ).<br><img src=\"data/11/1H8/im1H81/dlts_11_DLTS20_008.png\" alt=\"hinh ve\" style=\"max-width:min(560px,90%);max-height:300px;width:auto;height:auto;display:block;margin:8px auto;\">",
    "answer": "60",
