...
window.tracNghiem1D61 = [
  ...
  {
    "id": "1D612TN4",
    "question": "Cho $a$ là số thực dương. Rút gọn biểu thức $a^{\\tfrac{4}{3}} \\cdot \\sqrt{a}$, ta được",
    "options": [
      "$a^{\\tfrac{2}{3}}$",
      "$a^{\\tfrac{11}{6}}$",
      "$a^{\\tfrac{5}{6}}$",
  ...
  {
    "id": "1D612TN5",
    "question": "Cho biểu thức $P=\\sqrt[4]{x^5}$, với $x&gt;0$. Khẳng định nào sau đây đúng?",
    "options": [
      "$P=x^9$",
      "$P=\\dfrac{4}{5}x^5$",
      "$P=x^\\frac{5}{4}$",
  ...
  {
    "id": "1D612TN6",
    "question": "Cho biểu thức $P=\\sqrt[4]{x^5}$, với $x&gt;0$. Mệnh đề nào dưới đây là mệnh đề <strong>đúng</strong>?",
    "options": [
      "$P=x^9$",
      "$P=x^{\\tfrac{4}{5}}$",
      "$P=x^{20}$",
  ...
  {
    "id": "1D612TN7",
    "question": "Giá trị của $K=\\left(\\dfrac{1}{81}\\right)^{-0{,}75}+\\left(\\dfrac{1}{27}\\right)^{-\\tfrac{4}{3}}$ bằng",
    "options": [
      "$K=18$",
      "$K=108$",
      "$K=180$",
  ...
  {
    "id": "1D611TN8",
    "question": "Cho các số thực $a$, $b$, $\\alpha$ ($a&gt;b&gt;0$, $\\alpha\\ne1$). Mệnh đề nào sau đây <strong>đúng</strong>?",
    "options": [
  ...
  {
    "id": "1D612TN9",
    "question": "Với $a$ là số thực dương tùy ý, $\\sqrt[5]{a^3}$ bằng",
    "options": [
      "$a^{\\frac{1}{15}}$",
      "$a^{15}$",
      "$a^{\\frac{3}{5}}$",
  ...
  {
    "id": "1D612TN10",
    "question": "Cho $a$, $b$ là hai số thực dương và $m$, $n$ là hai số thực tùy ý. Đẳng thức nào sau đây là {\\bf sai}?",
    "options": [
      "$a^m a^n=a^{m+n}$",
      "$(a b)^n=a^n b^n$",
      "$(a^m)^n=a^{m n}$",
  ...
  {
    "id": "1D612TN11",
    "question": "Cho $a$ là số thực dương. Rút gọn biểu thức $P=a^{\\tfrac{2}{5}} \\cdot \\sqrt[3]a$ được kết quả là",
    "options": [
      "$a^{\\tfrac{2}{15}}$",
      "$a^{\\tfrac{17}{5}}$",
      "$a^{\\tfrac{11}{15}}$",
  ...
  {
    "id": "1D612TN12",
    "question": "Biểu thức $x \\cdot \\sqrt[3]{x}$ ($x &gt; 0$) được viết dưới dạng luỹ thừa với số mũ hữu tỉ là",
    "options": [
      "$x^{\\tfrac{2}{3}}$",
      "$x^{\\tfrac{5}{2}}$",
      "$x^{\\tfrac{7}{3}}$",
  ...
  {
    "id": "1D612TN13",
    "question": "Với $a$ là số thực dương tùy ý, biểu thức $\\sqrt[3]{a^2}$ bằng",
    "options": [
      "$a^6$",
      "$a^{\\tfrac{2}{3}}$",
      "$a^{\\tfrac{3}{2}}$",
  ...
  {
    "id": "1D612TN14",
    "question": "Với $a&gt;0$, $b&gt;0$, $\\alpha$, $\\beta$ là các số thực bất kì, đẳng thức nào sau đây $\\mathbf{sai}$?",
    "options": [
  ...
  {
    "id": "1D612TN15",
    "question": "Với $a$ là số thực dương tùy ý, $a^4 \\cdot a^{\\tfrac{1}{2}}$ bằng",
    "options": [
      "$a^{\\tfrac{9}{2}}$",
      "$a^2$",
      "$a^{\\tfrac{7}{2}}$",
  ...
  {
    "id": "1D612TN16",
    "question": "Cho biểu thức $\\sqrt[5]{8\\sqrt{2\\sqrt[3]{2}}}=2^{\\frac{m}{n}}$, trong đó $\\dfrac{m}{n}$ là phân số tối giản. Gọi $P=m+n^2$. Khẳng định nào sau đây đúng?",
    "options": [
      "$P\\in (260; 270)$",
      "$P\\in(250;260)$",
      "$P\\in(230;240)$",
