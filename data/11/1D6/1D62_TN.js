// =========================================================================
// KHỐI DỮ LIỆU: 1D62 - Trắc nghiệm (nguồn DeLuyenTap)
// Nguồn: DeLuyenTap (chuyển từ LaTeX)
// =========================================================================
window.tracNghiem1D62 = [
  {
    "id": "1D622TN1",
    "question": "Nếu $a^{\\tfrac{1}{2}} = b$ ($a &gt; 0$, $a \\ne 1$) thì",
    "options": [
      "$2\\log_a b = 1$",
      "$\\log_{\\tfrac{1}{2}} b = a$",
      "$\\log_a \\tfrac{1}{2} = b$",
  ...
  {
    "id": "1D622TN2",
    "question": "Cho $0 &lt; a \\ne 1$, khi đó $\\log_a \\sqrt[7]{a}$ bằng:",
    "options": [
      "$-\\dfrac{1}{7}$",
      "$7$",
      "$-7$",
  ...
  {
    "id": "1D622TN5",
    "question": "Cho $a$, $b$ là hai số thực dương thỏa mãn $a b^3=16$. Giá trị biểu thức $\\log_2 a+3\\log_2 b$ bằng",
    "options": [
      "$16$",
      "$8$",
      "$4$",
  ...
  {
    "id": "1D622TN6",
    "question": "Cho các số thực dương $x$, $y$ thoả mãn $\\log _2x=a$, $\\log _2y=b$. Giá trị của biểu thức $\\log _2\\left(x^2y^3\\right)$ bằng",
    "options": [
      "$6ab$",
      "$a^2b^3$",
      "$a^2+b^3$",
  ...
  {
    "id": "1D621TN7",
    "question": "Cho $a$, $b$ là các số thực dương. Khẳng định nào sau đây đúng?",
    "options": [
      "$\\ln \\dfrac{b}{a}=\\ln a-\\ln b$",
  ...
  {
    "id": "1D621TN8",
    "question": "Cho $a$, $b$, $c$ là các số dương và $a\\ne1$, khẳng định nào sau đây <strong>sai</strong>?",
    "options": [
  ...
  {
    "id": "1D621TN10",
    "question": "Cho $2$ số thực dương $a$, $b$ với $a \\neq 1$. Khẳng định nào sau đây là đúng?",
    "options": [
  ...
  {
    "id": "1D622TN11",
    "question": "Với $a \\ne 0$ là số thực tùy ý, $\\log_9 a^2$ bằng",
    "options": [
      "$2\\log_3 a^2$",
      "$\\log_3 |a|$",
      "$\\log_3 a$",
  ...
  {
    "id": "1D622TN12",
    "question": "Cho $a$ là số thực dương khác $1$. Tính $\\log_a \\sqrt[3]{a^7}$ ta được kết quả là",
    "options": [
      "$\\dfrac{3}{7}$",
      "$\\dfrac{7}{3}$",
      "$\\dfrac{10}{3}$",
  ...
  {
    "id": "1D621TN13",
    "question": "Với mọi số thực dương $a$, $b$, $x$, $y$ và $a$, $b \\ne 1$, mệnh đề nào sau đây <strong>sai</strong>?",
    "options": [
  ...
  {
    "id": "1D622TN14",
    "question": "Với $a$ là số thực dương tùy ý, $\\log_2 3 + \\log_2 a$ bằng",
    "options": [
      "$\\log_2 3 \\cdot \\log_2 a$",
      "$\\log_2 a^3$",
      "$\\log_2 (3 + a)$",
      "$\\log_2 (3a)$"
    ],
  ...
  {
    "id": "1D622TN15",
    "question": "Giá trị của $\\log_{4}8$ bằng",
    "options": [
      "$\\dfrac{2}{3}$",
      "$\\dfrac{3}{2}$",
      "$2$",
  ...
  {
    "id": "1D622TN16",
    "question": "Với mọi số thực $a$ dương, $\\log_2(8a)$ bằng:",
    "options": [
      "$3+\\log_2 a$",
      "$\\log_2 a-3$",
      "$3 \\log_2 a$",
  ...
  {
    "id": "1D622TN17",
    "question": "Cho $\\log_{a}{b} = 2$ và $\\log_{a}{c} = 3$ với $a$, $b$, $c&gt;0$, $a \\ne 1$. Tính $P = \\log_{a}(b^2\\cdot c^3)$.",
    "options": [
      "$P=31$",
      "$P=13$",
      "$P=30$",
  ...
  {
    "id": "1D622TN18",
    "question": "Cho $\\log_a b = 2$; $\\log_a c = 3$. Tính $Q = \\log_a \\left(b^3 c\\right)$.",
    "options": [
      "$Q=4$",
      "$Q=9$",
      "$Q=10$",
  ...
  {
    "id": "1D622TN19",
    "question": "Biết $a$, $b$ là các số thực dương khác $1$ thỏa mãn $\\log_a b=3$. Giá trị $\\log_{a^2}\\dfrac{a}{\\sqrt{b}}$ bằng",
    "options": [
      "$\\dfrac{5}{8}$",
      "$\\dfrac{5}{2}$",
      "$-\\dfrac{1}{4}$",
  ...
  {
    "id": "1D622TN20",
    "question": "Với $a$ là số thực dương tùy ý, $\\log_2a^2$ bằng",
    "options": [
      "$2+\\log_2a$",
      "$\\dfrac{1}{2}\\log_2a$",
      "$\\dfrac{1}{2}+\\log_2a$",
